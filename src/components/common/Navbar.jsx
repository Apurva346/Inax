  ...
  return (
    <>
      ...
      >
        ...
        <nav
          className={`w-full bg-[#f9fafb] shadow-[0_10px_35px_rgba(0,0,0,0.15)] border-b border-gray-200 transition-all duration-300`}
        >
          <div className='max-w-7xl mx-auto flex justify-between items-center h-24 px-4'>
            {/* LOGO */}
            <Link to='/' className='flex items-center group'>
              <img
                src='/himages/inax-logo.png'
                alt='I-NAX Precision'
                className='h-18 w-auto object-contain transition-transform duration-300 group-hover:scale-105 drop-shadow-md'
              />
            </Link>
            ...
            <div className='hidden lg:flex gap-8 items-center'>
              ...
              {/* फिक्स केलेला भाग: इथून चुकीचा onClick इव्हेंट काढून टाकला आहे */}
              ...
              {/* <NavLink to='/all-machines' label='ALL MACHINES' /> */}
              ...
              <div className='flex flex-col p-6 space-y-1'>
                ...
                <div className='border-b border-gray-100'>
                  ...
                  >
                    Machines
                    {mobileMachinesOpen ? (
                      <ChevronDown size={18} className='text-[#b91c1c]' />
                    ) : (
                      <ChevronRight size={18} />
                    )}
                  </button>

                  {/* Mobile Machine Items */}
                  {mobileMachinesOpen && (
                ...
                <Link
                  to='/contact'
                  onClick={() => setMobileMenu(false)}
                  className='flex items-center justify-between gap-3 font-bold p-5 mt-6 uppercase text-[12px] bg-[#b91c1c] text-white rounded-xl shadow-lg'
                >
